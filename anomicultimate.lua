...
loadstring(game:HttpGet('https://raw.githubusercontent.com/ALWEB2/robloxhacks/main/full'))()
--fixed bugs
wait(2)
...
loadstring(game:HttpGet('https://raw.githubusercontent.com/Shariiii/Anomic-Stuff/main/Baton%20Farm%20Script.lua'))()
